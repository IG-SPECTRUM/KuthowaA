...
export default function Products() {
  ...
  const products: ProductItem[] = [
    {
      id: "satin-bedsheet-sets",
      name: "Premium Satin Bed Sheet Sets",
      ...
      priceValue: "K550",
      image: "/images/satin_sheet_set.jpg",
      category: "Bedroom",
      waText: "Hi Kuthowa Creatives! I'm interested in the Premium Satin Bed Sheet Set. Could you tell me the available colours and sizes?",
    },
    {
      id: "satin-fleece-blanket",
      name: "Satin Fleece Blankets",
      desc: "Cozy fleece blankets with an elegant satin border for warmth and style.",
      benefits: "Provides luxurious warmth while maintaining a premium aesthetic in your bedroom.",
      sizes: "Single, Double, Queen, King",
      priceLabel: "Starting from",
      priceValue: "K400",
      image: "/images/satin_duvet_cover.jpg",
      category: "Bedroom",
      waText: "Hi Kuthowa Creatives! I'm interested in the Satin Fleece Blankets. Could you tell me the available colours?",
    },
    {
      id: "bed-under-skirt",
      ...
      priceLabel: "Starting from",
      priceValue: "K350",
      image: "/images/satin_mattress_cover.jpg",
    ...
    {
      id: "satin-pillowcases",
      name: "Satin Pillowcases (Ruffled)",
      desc: "Beautiful satin pillowcases with elegant ruffled edges for a romantic look.",
      ...
      category: "Bedroom",
      waText: "Hi Kuthowa Creatives! I'm interested in the Ruffled Satin Pillowcase. Could you tell me the available colours?",
    },
    {
      id: "plain-satin-pillowcases",
      name: "Satin Pillowcases (Plain)",
      desc: "Classic, minimalist satin pillowcases available in assorted colors.",
      benefits: "Provides a frictionless surface for your hair and skin while you sleep.",
      sizes: "Standard, Continental",
      priceLabel: "Starting from",
      priceValue: "K100",
      image: "/images/satin_sleep_mask.jpg",
      category: "Bedroom",
      waText: "Hi Kuthowa Creatives! I'm interested in the Plain Satin Pillowcase. Could you tell me the available colours?",
    },
    {
      id: "satin-pajamas",
      name: "Satin Pajamas",
      desc: "Luxurious satin pajama sets featuring a ruffled top and matching shorts.",
      benefits: "Incredibly soft and comfortable for lounging and sleeping in style.",
      sizes: "S, M, XL, XXL",
      priceLabel: "Set Price",
      priceValue: "K150",
      image: "/images/satin_pajamas.jpg",
      category: "Gifts",
      waText: "Hi Kuthowa Creatives! I'm interested in the Satin Pajamas. Could you tell me the available colours and sizes?",
    },
    {
      id: "satin-head-scarfs",
      name: "Satin Head Scarfs",
      desc: "Elegant satin head scarfs available in assorted colors.",
      benefits: "Protects your hair throughout the day while adding a chic accessory to your outfit.",
      sizes: "One Size",
      priceLabel: "Each",
      priceValue: "K35",
      image: "/images/satin_scrunchies.jpg",
      category: "Accessories",
      waText: "Hi Kuthowa Creatives! I'm interested in the Satin Head Scarfs. Could you tell me the available colours?",
    },
    {
      id: "satin-bonnets",
      name: "Satin Bonnets",
      desc: "Premium double-lined satin bonnets with a comfortable tie band.",
      ...
      category: "Hair Care",
      waText: "Hi Kuthowa Creatives! I'm interested in the Satin Bonnets. Could you tell me the available colours?",
    },
  ];
    ...
    <section id="products" className="py-24 bg-white border-b border-gold/10">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 space-y-3">
          ...
          <h2 className="font-heading text-3xl md:text-4xl font-light text-charcoal">The Premium Satin Collection</h2>
          <div className="w-12 h-[1px] bg-gold/40 mx-auto my-4" />
          <p className="text-sm font-light text-charcoal-light leading-relaxed">
            Meticulously crafted using high-grade, high-density satin to elevate your beauty sleep and home decor.
          </p>
        </div>
